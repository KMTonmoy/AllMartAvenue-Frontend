    ...
    <section className="relative h-[80vh] w-full overflow-hidden">
            ...
            <div className="relative z-10 flex h-full items-center">
              <div className="container mx-auto px-8 text-white">
                <div className="max-w-2xl">
                  ...
                  <Button 
                    size="lg" 
                    className="bg-[#007873] hover:bg-teal-700 text-white px-8 py-6 text-lg font-medium rounded-lg"
                  >
                    {slide.buttonText}
                  </Button>
                </div>
      ...
      <div className="absolute bottom-6 right-6 z-20 flex items-center space-x-4">
        ...
        <Button
          variant="outline"
          size="icon"
          className="rounded-full bg-white/20 hover:bg-white/30 text-white border-none backdrop-blur-sm"
