...
const FlashSale = () => {
  ...
  useEffect(() => {
    fetch("/product.json")
      .then((res) => res.json())
      .then((data) => {
        // Filter products with "flash" tag
        const flashProducts = data.filter(
          (p: Product) => p.productTag === "flash"
        );
  ...
  if (products.length === 0) {
    return <p className="text-center py-10">No flash sale products available.</p>;
  }
    ...
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8 text-lg" style={{ fontFamily: "'Lato', sans-serif" }}>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <p className="text-gray-600 text-sm mb-4 line-clamp-2 flex-grow" style={{ fontFamily: "'Lato', sans-serif" }}>
                  {product.details}
                </p>
                ...
                {product.comments && product.comments.length > 0 && (
                  <div className="border-t border-gray-100 pt-3 mt-auto">
                    <h4 className="text-xs font-semibold text-gray-700 mb-1">Customer Reviews:</h4>
                    {product.comments.slice(0, 1).map((comment, idx) => (
                      <div key={idx} className="text-xs text-gray-600 mb-1 line-clamp-1">
